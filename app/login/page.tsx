  ...
  return (
    <div className="min-h-screen bg-[#F7F6FF] flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-[360px] bg-white rounded-2xl border border-[#E8E6F4] p-8 shadow-sm">
        ...
        <p className="text-sm text-zinc-500 mb-7">Sign in to your FieldLog account</p>

        <form className="space-y-4" action="/trainee">
          <div>
          ...
          <button
            type="submit"
            className="w-full bg-violet-600 text-white font-semibold py-2.5 rounded-lg text-sm hover:bg-violet-700 transition-colors mt-1"
          >
            Sign in
          </button>
        </form>
        ...
        <button className="w-full flex items-center justify-center gap-2.5 border border-zinc-200 rounded-lg py-2.5 text-sm font-medium text-zinc-700 hover:bg-zinc-50 transition-colors">
